...
const rules = [
  ...
  "দূর থেকে বা ভেন্যু ব্যতীত যারা খেলবেন তাদের ক্ষেত্রে বিবেচ্য বিষয় হচ্ছে গেইম শুরু হওয়ার কিক অফের আগ অবদি যদি নেটওয়ার্ক ইস্যু বা গেইম নিজ থেকে বের করে দেয়(unfinished match)তাহলে পুনরায় শুরু হবে।কিন্তু একবার কিক অফ হয়ে গেইম শুরু হয়ে নেটওয়ার্ক ইস্যু বা অন্য যেকোনো কারণে  গেইম যাকে উইনার হিসাবে ঘোষণা করবে সেই উইনার হবে।",
  "স্মার্ট এসিস্ট চালু থাকবে। চাইলে অফ করে খেলতে পারেন।",
  "অথিরিটির সিদ্ধান্তই চূড়ান্ত সিদ্ধান্ত। অথিরিটি যেকোনো সময় যেকোনো সিদ্ধান্ত পরিবর্তনের ক্ষমতা রাখে।",
];
